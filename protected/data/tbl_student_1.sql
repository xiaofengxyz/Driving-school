...
CREATE TABLE `tbl_student` (
  ...
  `apply_car_type` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `personal_id` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  `stdudent_id` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
  ...
  `origin_car_type` varchar(128) COLLATE utf8_unicode_ci NOT NULL,
...
-- ----------------------------
BEGIN;
INSERT INTO `tbl_student` VALUES ('20', 'test3', '0', '奔驰', '333333333333333333', 'c132111111', '15210757849', '1', '', '0000-00-00', '0000-00-00', '0', '0000-00-00', '0', '0000-00-00', '0', '');
COMMIT;
